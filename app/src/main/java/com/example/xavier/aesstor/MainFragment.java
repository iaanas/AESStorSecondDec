...
public class MainFragment extends ListFragment {
    ...
    class MainFragment$3 implements OnClickListener {
        ...
        public void onClick(View v) {
            ...
            Toast.makeText(MainFragment.this.getActivity(), "Clean /decrypt/!", 0).show();
        }
    }

    /* renamed from: com.example.xavier.aesstor.MainFragment$4 */
    class MainFragment$4 implements OnClickListener {
        MainFragment$4() {
        }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        ((ImageButton) getActivity().findViewById(R.id.resetPasswd)).setOnClickListener(new MainFragment$4());
    }
